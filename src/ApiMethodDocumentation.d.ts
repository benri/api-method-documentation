 ...
 * documentation block | `{}`
 */
declare class ApiMethodDocumentation extends
  AmfHelperMixin(
  Object) {
  readonly styles: any;
   ...
   */
  ignoreBaseUri: boolean|null|undefined;
   ...
   */
  callbacksOpened: boolean|null|undefined;
   ...
   */
  _computeCallbacks(method: object|null): Array<object|null>|null|undefined;
  render(): any;
